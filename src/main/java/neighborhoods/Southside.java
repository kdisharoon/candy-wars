...
public class Southside extends Neighborhood {
    ...
    public Southside() {
        ...
        messages[0] = "Hello from neighborhoods.Southside!";
        ...
        messages[4] = "HOORAY! You found a treasure chest of candy while walking through neighborhoods.Southside Riverfront Park!";
